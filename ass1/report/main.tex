...
\begin{table}[H]
  ...
  0.11                                   & 46                      & 27                        & 11                                                       \\ \hline
  0.15                                   & 9                     & 6                       & 4                                                      \\ \hline
  2                                   & 0.26                    & 0.25                      & 0.25                                                          \\ \hline
  \end{tabular}%
}
\end{table}

From the results presented in Table \ref{tab:task5} it is clear that the smallest queue distribution is the best as it has the lowest average queue length for all mean arrival times.
